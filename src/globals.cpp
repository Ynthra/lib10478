...
lib10478::Constraints constraints = {maxVel, maxAccel*0.4, maxDeccel*0.8, 0.15}; 
...
lib10478::Chassis chassis({-18,19,-20}, {-11,12,14}, false, new lemlib::V5InertialSensor{9,1.00557878}, outputVelocity, 
    trackWidth ,wheelDiameter, 
    constraints , &leftController, &rightController, &horizontalWheel);
