...
//42.5
lib10478::TrackingWheel horizontalWheel(&wheelSensor,-2.016806722689076_in,0_in);
...
lib10478::Chassis chassis({-18,19,-20}, {-11,12,14}, new lemlib::V5InertialSensor{16,1.00485}, outputVelocity, wheelDiameter, {12.5_in, maxVel, maxAccel*0.5, maxDeccel*0.8, 0.15}, &leftController, &rightController, &horizontalWheel);
